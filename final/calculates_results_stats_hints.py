...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_dogs'] = (result_stats_dic['n_correct_dogs']/result_stats_dic['n_dogs_img'])*100.0
    ...
    results_stats_dic['pct_correct_breed'] = (result_stats_dic['n_correct_breed']/result_stats_dic['n_dogs_img'])*100.0
