...
def print_results(results_dic, results_stats_dic, model, 
    ...
    #          results_stats_dic
    #
    print("{:20}: {:3d}".format('N Not-Dog Images',result_stat_dict['n_images']))


    # Prints summary statistics (percentages) on Model Run
    print(" ")
    for key, value in results_stats_dic.iteritems():
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (sum(results_dic[idx][3:]) == 1):
                print("  {}:".format(idx))
                print("    image label: {}".format(results_dic[idx][0]))
                print("    classifier labels: {}".format(results_dic[idx][1]))
